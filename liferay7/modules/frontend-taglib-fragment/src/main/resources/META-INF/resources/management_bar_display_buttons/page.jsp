...
for (String displayStyle : displayViews) {
	...
	else if(displayStyle.equals("tree")) {
		icon = "organizations"; //TODO: use a better icon, for now using a similar icon included in lexicon icons.
		label = displayStyle.substring(0, 1).toUpperCase() + displayStyle.substring(1);
	}
