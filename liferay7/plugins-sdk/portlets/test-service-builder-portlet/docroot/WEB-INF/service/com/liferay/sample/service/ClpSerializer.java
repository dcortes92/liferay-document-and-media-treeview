...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"test-service-builder-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "test-service-builder-portlet";
			}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.sample.exception.NoSuchFooException")) {
			return new com.liferay.sample.exception.NoSuchFooException(throwable.getMessage(),
				throwable.getCause());
		}
